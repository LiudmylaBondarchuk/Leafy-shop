...
<body>
  <div class="invoice">
    ...
    <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:40px">
      <div>
        <h1 style="font-size:28px;color:#15803d;margin-bottom:4px">🌿 Leafy</h1>
        <p style="color:#666;font-size:12px">Premium Teas & Coffees</p>
      </div>
    ...
    console.error("GET /api/admin/invoices/[orderId] error:", error);
