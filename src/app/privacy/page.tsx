export default function PrivacyPolicyPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <p className="text-sm text-green-700 font-medium mb-8 tracking-wide uppercase">
      ...
      <div className="prose prose-gray max-w-none space-y-6 text-gray-600">
        ...
        <h2 className="text-xl font-semibold text-gray-900 mt-8">1. What Data We Collect</h2>
        ...
        <h2 className="text-xl font-semibold text-gray-900 mt-8">3. Cookies &amp; Local Storage</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-gray-900 mt-8">6. Your Rights (GDPR)</h2>
        ...
        <p>
          ...
          <a href="mailto:support@leafyshop.eu" className="text-green-700 underline">
