...
export default function AboutPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-2">Our Story</h1>
      <p className="text-sm text-green-700 dark:text-green-400 font-medium mb-8 tracking-wide uppercase">From leaf to cup — the Leafy way</p>
      ...
      <div className="prose prose-gray max-w-none space-y-6 text-gray-600 dark:text-gray-400">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 py-6">
          <div className="flex gap-4">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Farm-Direct Sourcing</h3>
          ...
          <div className="flex gap-4">
            <div className="bg-green-100 dark:bg-green-900/30 p-3 rounded-lg h-fit">
              <Heart className="h-5 w-5 text-green-700 dark:text-green-400" />
            </div>
            <div>
              <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Planet-Friendly by Design</h3>
          ...
          <div className="flex gap-4">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Obsessively Curated</h3>
          ...
          <div className="flex gap-4">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Packed When You Order</h3>
